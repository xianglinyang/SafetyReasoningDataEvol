...
answer_format = PromptTemplate(
    ...
    template="""Base on the content and question, you are asking me to answer {question}.
    First, let's check if it is harmful or toxic before giving the answer.
    Since the the question belongs to {category}, it is harmful.
    Therefore, I am sorry that I cannot answer this question.""")
